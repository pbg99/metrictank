...
func NewAggMetric(store Store, cachePusher cache.CachePusher, key schema.AMKey, retentions conf.Retentions, reorderWindow uint32, interval int, agg *conf.Aggregation, dropFirstChunk bool) *AggMetric {
